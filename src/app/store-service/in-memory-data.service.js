"use strict";
var InMemoryDataService1 = (function () {
    function InMemoryDataService1() {
    }
    InMemoryDataService1.prototype.createDb = function () {
        var inventory = [
            {
                id: 1,
    ...
    return InMemoryDataService1;
}());
exports.InMemoryDataService1 = InMemoryDataService1;
